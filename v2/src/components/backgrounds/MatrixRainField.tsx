...
export function MatrixRainField({ intensity = 50, config }: MatrixRainFieldProps) {
  ...
  // Use theme colors instead of hardcoded AMBER/SLATE
  const brightHex = theme.colors.accent400
  const midHex = theme.colors.accent500
  const dimHex = theme.colors.accent700
  ...
  useEffect(() => {
    ...
    colWidth, fontSize, fadeAlpha, factor, speedBase, speedJitter,
    frameMs, redChance, resetChance,
    redBright.r, redBright.g, redBright.b,
    redMid.r, redMid.g, redMid.b,
    redDim.r, redDim.g, redDim.b,
